...
const mart_orders = {
  order_id: "A unique identifier for each order. refers to id in snp.orders_lavka",
  preorder_id: "An identifier for pre-orders.",
  batch_id: "An identifier for a batch of orders.",
  warehouse_id: "An identifier for the warehouse fulfilling the order. Refers to id in snp.warehouses",
  batch_n: "The number of order in the batch.",
  order_lat: "The latitude coordinate of the order's delivery location.",
  order_long: "The longitude coordinate of the order's delivery location.",
  wh_lat: "The latitude coordinate of the warehouse.",
  wh_long: "The longitude coordinate of the warehouse.",
  order_distance: "The distance from warehouse to the delivery address.",
  price: "The price of the order excluding fees and promocode discounts",
  is_internal_order: "A flag indicating if the order is internal and made by warehouse staff",
  has_alcohol: "A flag indicating if the order contains alcohol.",
  has_coffee: "A flag indicating if the order contains coffee.",
  has_tobacco: "A flag indicating if the order contains tobacco.",
  has_energy_drinks: "A flag indicating if the order contains energy drinks.",
  n_items: "The number of items in the order.",
  original_price: "The original price of the order before promocodes excluding fees",
  service_fee_purchase: "A flag indicating if a service fee was purchased.",
  delivery_fee_purchase: "A flag indicating if a delivery fee was purchased.",
  yandex_delivery_fee_purchase: "A flag indicating if a Yandex delivery fee was purchased.",
  service_fee_price: "The price of the service fee.",
  delivery_fee_price: "The price of the delivery fee.",
  yandex_delivery_fee_price: "The price of the Yandex delivery fee.",
  total_additional_price: "The total additional price for the order.",
  created_at: "The timestamp when the order was created.",
  picker_id: "An identifier for the picker assigned to the order.",
  courier_delivered: "An identifier for the courier who delivered the order.",
  paid_at: "The timestamp when the order was paid.",
  paid_flg: "A flag indicating if the order was paid.",
  address: "The delivery address for the order.",
  order_received: "The timestamp when the order was received.",
  picker_assigned: "The timestamp when a picker was assigned to the order.",
  picker_assigned_seconds: "The time in seconds a picker was assigned.",
  picker_collecting: "The timestamp when the picker started collecting items.",
  picker_collecting_seconds: "The time in seconds the picker spent collecting items.",
  picker_collected: "The timestamp when the picker finished collecting items.",
  picker_collected_seconds: "The time in seconds the picker spent collecting items.",
  wait_batching: "The timestamp when the order started waiting for batching.",
  batching_wait_seconds: "The time in seconds the order waited for batching.",
  last_order_ready_for_delivery: "The timestamp when the last order in a batch was ready for delivery.",
  courier_first_offer_dttm: "The timestamp of the first offer to a courier.",
  courier_last_offer_dttm: "The timestamp of the last offer to a courier.",
  no_courier_seconds: "The time in seconds there was no courier available.",
  taken_dttm: "The timestamp when the order was taken by a courier.",
  order_delivered_dttm: "The timestamp when the order was delivered.",
  delivery_seconds: "The time in seconds taken for delivery.",
  arrived_to_address_dttm: "The timestamp when the courier arrived at the delivery address.",
  arrived_seconds: "The time in seconds the courier spent at the address.",
  back_to_warehouse_dttm: "The timestamp when the courier returned to the warehouse.",
  back_seconds: "The time in seconds the courier spent returning to the warehouse.",
  autofinish_flg: "A flag indicating if the order was autofinished.",
  order_canceled: "The timestamp when the order was canceled.",
  batch_type: "The type of batch. May be manual, by angle, by distance, by time.",
  max_quantity: "The maximum quantity for an item in the order.",
  courier_motivation_amount: "The motivation amount for the courier.",
  courier_motivation_time: "The motivation time for the courier.",
  employee_rate_id: "An identifier for the employee rate.",
  got_bonus: "A flag indicating if a bonus was received.",
  polygon_id: "An identifier for the delivery polygon.",
  amount: "Original courier motivation.",
  paid_amount: "Actual motivation amount paid for the order.",
  rider_coefficient: "The rider coefficient.",
  paid_rider_coefficient: "The paid rider coefficient.",
  shift_id: "An identifier for the shift.",
  from_eta: "The lower bound of the estimated time of arrival.",
  to_eta: "The upper bound of the estimated time of arrival.",
  eta: "The estimated time of arrival.",
  surge_enable: "A flag indicating if surge pricing is enabled.",
  min_check_amount: "The minimum check amount.",
  user_id: "An identifier for the user who placed the order.",
  platform: "The platform used to place the order. May be choco and indrive",
  payment_id: "An identifier for the payment in indrive payments",
  order_num: "The order number of a user",
  status: "The current status of the order. 8- cancelled.",
  is_fraud: "A flag indicating if the order is considered fraudulent."
};
